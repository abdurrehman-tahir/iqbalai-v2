...
export type SchoolStudentOnboardingRead = Schemas["SchoolStudentOnboardingRead"];
export type SchoolStudentOnboardingState = Schemas["SchoolStudentOnboardingState"];
export type StudentProfileRead = Schemas["StudentProfileRead"];
export type StudentProfileBasicComplete = Schemas["StudentProfileBasicComplete"];
export type StudentModeSelect = Schemas["StudentModeSelect"];
export type StudentModeRead = Schemas["StudentModeRead"];
export type StudentModeUpdate = Schemas["StudentModeUpdate"];
export type StudyModeLiteral = StudentModeRead["active_mode"];
export type DiagnosticRead = Schemas["DiagnosticRead"];
export type DiagnosticResultRead = Schemas["DiagnosticResultRead"];
export type DiagnosticStartRequest = Schemas["DiagnosticStartRequest"];
export type DiagnosticSaveAnswers = Schemas["DiagnosticSaveAnswers"];
export type FocusAreaRead = Schemas["FocusAreaRead"];
...
export type TeacherOfferingRead = Schemas["TeacherOfferingRead"];
export type WizardCurriculumRead = Schemas["WizardCurriculumRead"];
export type WizardTopicsRead = Schemas["WizardTopicsRead"];
export type WizardTopicOption = Schemas["WizardTopicOption"];
export type LectureDraftRead = Schemas["LectureDraftRead"];
export type LectureDraftUpsert = Schemas["LectureDraftUpsert"];
export type WizardReferenceRead = Schemas["WizardReferenceRead"];
...
export type LectureLinkCreate = Schemas["LectureLinkCreate"];
export type LectureLinkRead = Schemas["LectureLinkRead"];
export type LectureAssignmentScope = Schemas["LectureAssignmentScope"];
export type LectureAssignmentInput = Schemas["LectureAssignmentInput"];
export type LectureAssignmentRead = Schemas["LectureAssignmentRead"];
export type LectureAccessSettingsRead = Schemas["LectureAccessSettingsRead"];
export type LectureAccessSettingsUpdate = Schemas["LectureAccessSettingsUpdate"];
export type LectureRosterRead = Schemas["LectureRosterRead"];
export type RosterSectionRead = Schemas["RosterSectionRead"];
export type RosterStudentRead = Schemas["RosterStudentRead"];
...
export type TeacherStudentQuizResultRead = Schemas["TeacherStudentQuizResultRead"];
export type QuizOfferingAggregateRead = Schemas["QuizOfferingAggregateRead"];
export type LectureImageUploadRead = Schemas["LectureImageUploadRead"];
export type DiagramSuggestion = Schemas["DiagramSuggestion"];
export type DiagramSuggestionsRead = Schemas["DiagramSuggestionsRead"];
export type DiagramSuggestionAccept = Schemas["DiagramSuggestionAccept"];
export type EditSessionStartRequest = Schemas["EditSessionStartRequest"];
export type EditSessionHeartbeatRequest = Schemas["EditSessionHeartbeatRequest"];
export type EditSessionRead = Schemas["EditSessionRead"];
export type CoachingSuggestionRead = Schemas["CoachingSuggestionRead"];
export type CoachingResponseRequest = Schemas["CoachingResponseRequest"];
export type TeacherBenchmarkRead = Schemas["TeacherBenchmarkRead"];
...
export type IndependentLectureGenerateRequest = Schemas["IndependentLectureGenerateRequest"];
export type IndependentLectureRead = Schemas["IndependentLectureRead"];
...
export type FrameworkStudyPlanRead = Schemas["FrameworkStudyPlanRead"];
export type FrameworkRejectRequest = Schemas["FrameworkRejectRequest"];
export type AvailableFrameworkRead = Schemas["AvailableFrameworkRead"];
export type StudentSelectionRead = Schemas["StudentSelectionRead"];
export type StudentStudyPlanRead = Schemas["StudentStudyPlanRead"];
