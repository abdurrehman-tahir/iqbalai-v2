...
**Done:** T-113 (`cf19314`), T-114 (`604fc01`), T-115 (`1a39885`), T-116 (`b5e0894`), T-117 (`dee320e`, amendment A-003), T-118 (`ebad1eb`), T-119 (`be464c8`), T-120 (`63b7144`), T-121 (`5222fe4`, voice conversation — sd is STT-only, no verified AI4Bharat package; migrations not live-verified, Docker Desktop unresponsive), T-122 (`5b0dcda`, cross-grade/subject linking — scoped to self-link/auto-approve only, confirmed with Hamza; migration not live-verified, same Docker gap)
**Current ticket:** T-123 (next)
**Next:** ticket-loader for T-123 — per-lecture access control
