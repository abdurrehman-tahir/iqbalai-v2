...
9. **Implement the ticket** — backend + frontend + migration + tests as the ticket specifies
...
- [ ] `npm run test` (frontend) + `pytest` (backend) green locally
...
- [ ] Migrations cleanly upgrade both Alembic heads
