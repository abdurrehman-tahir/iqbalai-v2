...
| M-01a | Foundation Remediation + FE/Integration Enforcement | 1 | T-223 to T-236 | ~1 week | drafted | Nav reaches every page; ToS renders/scrolls; FE tests + typed client + model-first migrations enforced in CI |
