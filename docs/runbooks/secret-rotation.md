# Runbook: rotating an env-var secret

**Status:** Stub — populated reactively when first triggered.
**Severity:** P3 — planned operation
**Trigger:** Credential exposure, periodic rotation policy, or new team member onboarding

## Until populated

See `docs/ARCHITECTURE.md` §15.3 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §15.3
