# Runbook: MinIO unavailability

**Status:** Stub — populated reactively when first triggered.
**Severity:** P1 — file uploads/downloads broken
**Trigger:** MinIO health endpoint fails OR uploads/downloads return errors

## Until populated

See `docs/ARCHITECTURE.md` §1.7, §11.5 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §1.7, §11.5
