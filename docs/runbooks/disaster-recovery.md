# Runbook: full-system disaster recovery

**Status:** Stub — populated reactively when first triggered.
**Severity:** P1 — but ONLY ACTIVATED ONCE BACKUPS ARE ENABLED (Phase 2 per TODO.md). Until then this runbook is non-functional.
**Trigger:** VM lost, DB corrupted beyond repair, or other catastrophic failure

## Until populated

See `docs/ARCHITECTURE.md` §15.10 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §15.10
