# Runbook: NATS / JetStream unavailability

**Status:** Stub — populated reactively when first triggered.
**Severity:** P1 — events stop, real-time broken
**Trigger:** NATS health check fails OR event-publish errors spike

## Until populated

See `docs/ARCHITECTURE.md` §1.7, §9.4 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §1.7, §9.4
