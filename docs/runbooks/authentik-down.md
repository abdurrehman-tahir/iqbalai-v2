# Runbook: Authentik unavailability

**Status:** Stub — populated reactively when first triggered.
**Severity:** P1 for new logins — existing JWT sessions remain valid up to expiry
**Trigger:** Authentik health endpoint fails OR new logins return 5xx

## Until populated

See `docs/ARCHITECTURE.md` §1.7, §6.3 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §1.7, §6.3
