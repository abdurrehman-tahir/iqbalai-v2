# Runbook: Redis unavailability

**Status:** Stub — populated reactively when first triggered.
**Severity:** P1 — sessions invalid, Celery broken, cache cold
**Trigger:** Redis PING fails OR Redis down alert fires

## Until populated

See `docs/ARCHITECTURE.md` §1.7, §3.11 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §1.7, §3.11
