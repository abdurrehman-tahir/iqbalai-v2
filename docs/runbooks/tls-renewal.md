# Runbook: fixing failed TLS auto-renewal

**Status:** Stub — populated reactively when first triggered.
**Severity:** P2 — has lead time, critical if missed
**Trigger:** TLS cert expiry alert (<14 days) fires AND certbot renew is failing

## Until populated

See `docs/ARCHITECTURE.md` §15.12 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §15.12
