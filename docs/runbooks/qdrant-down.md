# Runbook: Qdrant unavailability

**Status:** Stub — populated reactively when first triggered.
**Severity:** P1 — RAG broken, but rest of app works
**Trigger:** Qdrant health endpoint fails OR Qdrant down alert fires

## Until populated

See `docs/ARCHITECTURE.md` §1.7, §7.5 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §1.7, §7.5
