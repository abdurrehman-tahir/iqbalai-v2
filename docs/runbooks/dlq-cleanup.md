...
**Severity:** P3 — typically next-business-day investigation
**Trigger:** Daily DLQ summary email shows new entries since previous check

## Until populated

See `docs/ARCHITECTURE.md` §10.11, §9.10 for the architectural context. The `docs/runbooks/README.md` explains the stub-and-grow philosophy.
...
**Cross-references:** ARCHITECTURE.md §10.11, §9.10
