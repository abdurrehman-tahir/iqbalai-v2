"""Self-study namespace notification dispatcher — T-083."""
...
async def notify_self_study_event(
    *,
    ...
    """Publish a self_study-namespace in-app notification."""
