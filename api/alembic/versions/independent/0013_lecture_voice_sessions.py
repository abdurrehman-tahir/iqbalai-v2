"""Independent migration: lecture voice session + turn tables (T-121, #25 acceptance #5).

Revision ID: independent_0013
Revises: independent_0012
Create Date: 2026-08-04

Purpose: lecture_voice_sessions / lecture_voice_turns (independent) — "Talk to
AI" voice conversation for independent teachers (flow-5 §3.4: "Independent
teachers also get voice mode for their lecture-plan generation.").
...
revision: str = "independent_0013"
down_revision: str = "independent_0012"
branch_labels: tuple[()] = ()
